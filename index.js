...
const eoy2020 ={
  ...
  classOf: {
    ...
    DefinitionService: 'CoreServices',
...
const eoy2021 ={
  edges: [
    ["User", "Lifecycle", "Github", "ArtifactRegistries"],
    ["Lifecycle", "AppDefinitonService", "TimelineService", "RolloutService", "TimelineService"],
    ["RolloutService", "System", "AWS", "GAE", "WixServerless", "BuildOutputService", "TimelineService"],
    ["BuildOutputService", "ArtifactRegistries"],
    ["Github", "TriggeringService"],
    ["TriggeringService", "BuildController"],
    ["BuildController", "BuildDefinitionService", "TimelineService", "FalconBuild", "BazelBuild"],
    ["TimelineService", "TimelineService"],
